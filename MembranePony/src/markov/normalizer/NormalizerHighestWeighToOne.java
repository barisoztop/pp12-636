 ...
 * @author rgreil
 */
public final class NormalizerHighestWeighToOne extends Normalizer {

	public NormalizerHighestWeighToOne(MarkovDirectedWeightedGraph graph) {
		this.graph = graph;
		neighbor = new DirectedNeighborIndex(this.graph);
		logger = Logger.getLogger(NormalizerHighestWeighToOne.class);
		compute();
	}
