...
/**
 * predictor factory for markov predictor. everyone except robert should use this 
 * to spawn new instances of the predictor class.
 * 
 * @author Felix
 *
 */
public class MarkovPredictorFactory implements PredictorFactory {
	...
	/**
	 * Performs arcane magic, not the hat-and-bunny-sort of magic, but real, steak-frying, fries-salting,
	 * salad-munching kind. The one that transforms a boring BBQ into a veritable munchfest.
	 * 
	 * @param range
	 */
